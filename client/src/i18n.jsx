...
const en={
  ...
  'nav.schedule':'Schedule','nav.gallery':'Gallery','nav.offers':'Offers','nav.play':'Play','nav.about':'About','nav.contact':'Contact','nav.account':'Account','nav.tickets':'My tickets','nav.getTickets':'Get tickets','nav.open':'Open menu','nav.close':'Close menu',
...
const uk={
  ...
  'nav.schedule':'Розклад','nav.gallery':'Галерея','nav.offers':'Пропозиції','nav.play':'Грати','nav.about':'Про нас','nav.contact':'Контакти','nav.account':'Акаунт','nav.tickets':'Мої квитки','nav.getTickets':'Купити квитки','nav.open':'Відкрити меню','nav.close':'Закрити меню',
...
const ru={...uk,
  ...
  'nav.schedule':'Расписание','nav.gallery':'Галерея','nav.offers':'Предложения','nav.play':'Играть','nav.about':'О нас','nav.contact':'Контакты','nav.account':'Аккаунт','nav.tickets':'Мои билеты','nav.getTickets':'Купить билеты','nav.open':'Открыть меню','nav.close':'Закрыть меню',
...
export function I18nProvider({children}){
  const [language,setLanguage]=useState(()=>{
    ...
    return browser.startsWith('uk') ? 'uk' : browser.startsWith('ru') ? 'ru' : 'en';
  });
  useEffect(()=>{
